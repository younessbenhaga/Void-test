...
import img3 from "./pasted-graphic-2.webp";
function Main_3() {
    return (
        <div className="xl:grid xl:grid-cols-12 flex flex-col-reverse mt-32">
          <div className="rounded-lg p-2 xl:col-span-5">
            <h2 className="text-2xl md:text-4xl font-bold leading-[54px]">
              200 jours avant les Jeux Paralympiques
            </h2>
            <p className="text-sm mt-5">
              Si vous n'avez pas encore entendu parler du #DrapeauMéningites,
              regardez la vidéo de Vaskange et découvrez la signification de
              chaque couleur.
            </p>
